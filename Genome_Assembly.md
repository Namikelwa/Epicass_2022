...
Taking a look at the text report
...
hifiasm -o ${outdir}/asm_hifi_reducedPB -t8 ${indir}/reducedPB_clean.fastq 2> hifiasm.log
...
quast.py ${res_path}/asm_spades/scaffolds.fasta  ${res_path}/asm_flye/assembly.fasta ${res_path}/asm_hifi_reducedPB/asm_hifi_reducedPB.p_ctg.fa -o ${res_path}/quast_all_assemblies _report


Now take a look at the text report

cat ${res_path}/quast_ all_assemblies _report/report.txt
